...
The fastest Duolingo hack on Github.

> [!IMPORTANT]
> **Read all** documents in this repo before doing anything!
> 
> - **Don't make this into your own tool**
> - **Must fork before use**
> - **Dont share your TOKEN or USER_ID to anyone**
> - **Must put TOKEN and USER_ID in Secret**
> - **Should use normal Get XP instead of Boost XP**
> - Don't forget to star ⭐ this repository

### Issues & Bugs
- Check for any mistakes you may have made before report.
- If you are certain it is a problem with the code, go to the [**Issues**](https://github.com/cole-bauml/duolingo-hacks/issues/new) tab of the repo and create a new issue.
...
- Boost XP (2 times faster than normal but higher ban rate and rate limiting leads to account freeze.)
